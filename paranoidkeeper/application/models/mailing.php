...
class mailing extends CI_Model {
    ...
    public function __construct() {
        ...
        $this->mailing->Host = "smtp.gmail.com";
        $this->mailing->Port = 465;
        $this->mailing->SMTPSecure = 'ssl';
        $this->mailing->SMTPAuth = true;
        $this->mailing->Username = "albertovictorialopez93@gmail.com";
        $this->mailing->Password = "guapo1991";
        $this->mailing->From = "albertovictorialopez93@gmail.com";
